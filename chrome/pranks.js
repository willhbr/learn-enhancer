...
function aprilFools() {
  ...
  [
    ...
    () => {
      let styles = '.block {animation: spin-baby 6s linear infinite;} @keyframes spin-baby {from {transform: rotate(0deg);} to {transform: rotate(360deg);}}';
    ...
    () => {
      let styles = '.block div {animation: hue-baby 1s linear infinite;} @keyframes hue-baby {0% {background-color: #990886;} 50% {background-color: #0F990D;} 100% {background-color: #990886;}}';
      add('<style>' + styles + '</style>');
    },
